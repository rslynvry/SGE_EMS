<template>
    ...
    <div class="components">
        <div class="row">
            <div class="col-6">
                <h2>ELECTIONS ({{ userStore.student_organization_name }}) Organization</h2>
            </div>
            <div class="col-6 new">
...
<script>
    ...
    export default {
        setup(props) {
            // Since this is the landing page for the Officer after loggin in,
            // We need to set the user's role to officer in the user store
            ...
            userStore.student_organization_id = props.student_organization_id;
            userStore.student_organization_name = props.student_organization_name;
            ...
            const fetchElectionsTable = async () => {
                const response = await axios.get(`${import.meta.env.VITE_FASTAPI_BASE_URL}/api/v1/election/all/organization/${userStore.student_organization_id}`);
